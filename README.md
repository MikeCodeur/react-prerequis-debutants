<div>
  <h1 align="center"><a href="https://go.mikecodeur.com/react-mastery">React Prérequis débutants 🚀 ReactMastery.Dev</a></h1>
  <strong>
    L'essentiel pour démarrer avec React quand on part de Zéro 
  </strong>
  <p>
    Module de la formation React Mastery. Module facultatif pour tous les débutants qui arrivent dans le monde du web.
  </p>

  <a href="https://go.mikecodeur.com/react-mastery">
    <img 
      alt="Apprendre React"
      src="https://mikecodeur.com/mike/assets/courses/react-mastery-1.png"
    />
  </a>
...
```
git clone https://github.com/MikeCodeur/react-prerequis-debutants.git
cd react-prerequis-debutants
npm run init
```
